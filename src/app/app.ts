...
export class AppComponent implements OnInit, OnDestroy {
  ...
  translations = {
    en: {
      ...
      advancedUserManagement: 'User Management',
      advancedUserManagementDesc: 'Role-based access • Unlimited users',
      advancedPermissions: 'Permissions & Roles',
      advancedPermissionsDesc: 'Granular control for every module and action.',
      advancedWorkflow: 'Workflow & Approvals',
      advancedWorkflowDesc: 'Multi-level approvals • Project & warehouse approvals • Approve/reject from mobile & PC.',
      advancedMyTasks: 'My Tasks',
      advancedMyTasksDesc: 'All requests & approvals in one place for each user.',
      advancedNotifications: 'Notifications System',
      advancedNotificationsDesc: 'In-app notifications • Email alerts • Mobile push • Low stock alerts • Request reminders.',
      advancedSettings: 'Settings & Controls',
      advancedSettingsDesc: 'Configure workflow, alerts, notifications, and system behaviors to match your policies.',
      // Comparison section
      comparisonExcelTitle: 'Excel / WhatsApp',
      comparisonExcelNoAccuracy: 'No accuracy',
      comparisonExcelLostRequests: 'Lost requests',
      comparisonExcelNoDashboards: 'No dashboards',
      comparisonExcelNoAudit: 'No audit trail',
      comparisonExcelNoAutomation: 'No automation',
      comparisonStockOrbitTitle: 'StockOrbit',
      comparisonStockOrbitAccuracy: 'Real-time accuracy',
      comparisonStockOrbitAudit: 'Full audit history',
      comparisonStockOrbitWorkflows: 'Structured workflows',
      comparisonStockOrbitDashboards: 'Live dashboards',
      comparisonStockOrbitReports: 'Powerful reports',
      comparisonStockOrbitAI: 'AI Assistant',
      comparisonStockOrbitNotifications: 'Notifications everywhere',
      comparisonStockOrbitDesigned: 'Designed for real operations',
      // Support section
      supportUpdatesTitle: 'Continuous Updates — All Year Long',
      supportUpdatesDesc: 'Quarterly UI/UX updates • New modules • Bug fixes • Enhancements.',
      supportFastTitle: 'Fast Support',
      supportFastDesc: 'WhatsApp • Remote sessions • Email support • Training.',
    },
    ar: {
      ...
      // Advanced Features cards
      advancedUserManagement: 'إدارة المستخدمين',
      advancedUserManagementDesc: 'وصول قائم على الأدوار • مستخدمون غير محدودين',
      advancedPermissions: 'الأدوار والصلاحيات',
      advancedPermissionsDesc: 'تحكم دقيق لكل وحدة وإجراء.',
      advancedWorkflow: 'أساليب العمل والموافقات',
      advancedWorkflowDesc: 'موافقات متعددة المستويات • موافقات المشروع والمستودع • الموافقة/الرفض من الهاتف والكمبيوتر.',
      advancedMyTasks: 'مهامي',
      advancedMyTasksDesc: 'جميع الطلبات والموافقات في مكان واحد لكل مستخدم.',
      advancedNotifications: 'نظام الإشعارات',
      advancedNotificationsDesc: 'إشعارات داخل التطبيق • تنبيهات البريد الإلكتروني • إشعارات الهاتف المحمول • تنبيهات المخزون المنخفض • تذكيرات الطلبات.',
      advancedSettings: 'الإعدادات والتحكم',
      advancedSettingsDesc: 'قم بتكوين أساليب العمل والتنبيهات والإشعارات وسلوكيات النظام لتتناسب مع سياساتك.',
      // Comparison section
      comparisonExcelTitle: 'Excel / WhatsApp',
      comparisonExcelNoAccuracy: 'لا توجد دقة',
      comparisonExcelLostRequests: 'طلبات ضائعة',
      comparisonExcelNoDashboards: 'لا توجد لوحات معلومات',
      comparisonExcelNoAudit: 'لا يوجد سجل تدقيق',
      comparisonExcelNoAutomation: 'لا توجد أتمتة',
      comparisonStockOrbitTitle: 'ستوك أوربت',
      comparisonStockOrbitAccuracy: 'دقة فورية',
      comparisonStockOrbitAudit: 'سجل تدقيق كامل',
      comparisonStockOrbitWorkflows: 'أساليب عمل منظمة',
      comparisonStockOrbitDashboards: 'لوحات معلومات مباشرة',
      comparisonStockOrbitReports: 'تقارير قوية',
      comparisonStockOrbitAI: 'مساعد ذكي',
      comparisonStockOrbitNotifications: 'إشعارات في كل مكان',
      comparisonStockOrbitDesigned: 'مصمم للعمليات الحقيقية',
      // Support section
      supportUpdatesTitle: 'تحديثات مستمرة — طوال العام',
      supportUpdatesDesc: 'تحديثات UI/UX ربع سنوية • وحدات جديدة • إصلاحات الأخطاء • تحسينات.',
      supportFastTitle: 'دعم سريع',
      supportFastDesc: 'WhatsApp • جلسات عن بُعد • دعم البريد الإلكتروني • تدريب.',
    },
  } as const;
